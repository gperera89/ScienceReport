const Involvement = ({ involementRating, name, pronoun }) => {
	switch (involementRating) {
		...
		case 3:
			return ` In lessons, ${pronoun[0]} is good-humoured and contributes frequently to class discussions but hesitates to ask questions to clarify ${pronoun[2]} understanding. `;
		case 4:
