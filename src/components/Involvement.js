const Involvement = ({ involementRating, name, pronoun }) => {
	switch (involementRating) {
		...
		case 3:
			return ` In lessons, ${pronoun[0]} is good-humoured and makes frequent contributions to class discussions and but hesitates to ask questions to clarify ${pronoun[2]} understanding. `;
		case 4:
