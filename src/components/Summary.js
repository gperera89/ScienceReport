const Summary = ({ improvement, name, pronoun }) => {
	switch (improvement) {
		...
		case "Speaking in Class":
			return `${name} should aim to develop ${pronoun[2]} articulation of scientific ideas further, as this will extend ${pronoun[2]} understanding as well as build skills which will be crucial in ${pronoun[2]} future. With more involvement in class, ${name} will continue to make progress in Science.`;
		default:
			return "";
	}
};
